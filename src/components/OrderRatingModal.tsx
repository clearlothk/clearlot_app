        ...
        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-600 to-blue-800 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">評價賣家</h2>
                <p className="text-sm text-blue-100">為您的購買體驗評分</p>
              </div>
            </div>
            <button
              onClick={handleClose}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="請分享您對這次購買的體驗，包括商品品質、賣家服務、配送速度等..."
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-blue-700 mt-1 space-y-1">
                      <li>• 您的評價將幫助其他買家做出更好的選擇</li>
                      <li>• 評價將顯示在賣家的公開資料中</li>
                      <li>• 提交後無法修改，請仔細考慮</li>
                    </ul>
                  </div>
                </div>
